<?php
/**
 * Template Name: Landing Procedimientos
 */
...
<main>
  <div class="container-fluid">
    ...
    <?php 
        $protocolos = new WP_Query(array(
            'post_type'     => array('procedimientos'),
            'posts_per_page'  => -1,
            'post_status'   => 'publish',
    ...
    <?php if ($protocolos->have_posts() ) :  ?>
    <section class="container">
        <div class="row estadistica-busqueda">
          <div class="col col-12 categorias-badges">
      ...
      <?php if ( wp_is_mobile() ) : ?>
        <section class="container search-mobile">      
          <?php while ( $protocolos->have_posts() ) : $protocolos->the_post(); ?>      
            <div class="row">
